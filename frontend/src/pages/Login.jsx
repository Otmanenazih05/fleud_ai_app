...
import login_bg1 from "../assets/login_bg.jpg"
import { useGoogleLogin } from "@react-oauth/google"
import { useAuth } from "../context/AuthContext"
import { validateLoginData } from "../helpers/dataValidation"
        ...
        <div className="w-7/8 h-[85vh] mt-10 mx-auto flex bg-gray-300 rounded-2xl">
            <div className="form-side h-full w-1/2 p-10 relative flex items-center justify-center">
                ...
                <Form method="post" className="w-full">
                    <h1 className="text-4xl font-bold mb-1 text-orange-600">Login</h1>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-gray-500 text-center">Don't have an account? <Link to="/signup" className="text-orange-600 font-medium">Sign Up</Link></p>
                    </div>
                </Form>
            </div>
            <div
            ...
            >
                <div
                    className="w-[90%] h-50 backdrop-blur-sm rounded-xl p-6 shadow-[0_8px_32px_0_rgba(104, 113, 230, 0.37)]] absolute bottom-5 left-7 transition-opacity duration-200"
                >
